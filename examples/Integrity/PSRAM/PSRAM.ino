...
#define MYPSRAM 16 // 8	// compile time PSRAM size and is T_4.1 specific either 8 or 16, or smaller portion
...
#define NUMDIRS 24  // When not ROOTONLY must be 1 or more
